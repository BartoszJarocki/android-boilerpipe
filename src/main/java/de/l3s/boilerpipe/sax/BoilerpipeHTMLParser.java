...
/**
 * A simple SAX Parser, used by {@link de.l3s.boilerpipe.sax.BoilerpipeSAXInput}. The parser uses <a
...
public class BoilerpipeHTMLParser extends AbstractSAXParser implements BoilerpipeDocumentSource {
    ...
    /**
     * Constructs a {@link de.l3s.boilerpipe.sax.BoilerpipeHTMLParser} using a default HTML content handler.
     */
    ...
    /**
     * Constructs a {@link de.l3s.boilerpipe.sax.BoilerpipeHTMLParser} using the given {@link BoilerpipeHTMLContentHandler}.
     *
