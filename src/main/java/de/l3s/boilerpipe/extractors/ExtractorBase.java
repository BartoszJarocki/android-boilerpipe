...
public abstract class ExtractorBase implements BoilerpipeExtractor {
    ...
    /**
     * Extracts text from the HTML code available from the given {@link org.xml.sax.InputSource}.
     * 
    ...
    /**
     * Extracts text from the HTML code available from the given {@link java.net.URL}.
     * NOTE: This method is mainly to be used for show case purposes. If you are
     * going to crawl the Web, consider using {@link #getText(org.xml.sax.InputSource)}
     * instead.
     * 
     ...
     * 
     * @param doc The {@link de.l3s.boilerpipe.document.TextDocument}.
     * @return  The extracted text.
     * @throws BoilerpipeProcessingException
     */
