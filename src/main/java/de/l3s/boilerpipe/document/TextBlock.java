...
public class TextBlock implements Cloneable {
    ...
    /**
     * Adds an arbitrary String label to this {@link de.l3s.boilerpipe.document.TextBlock}.
     * 
     * @param label The label
     * @see de.l3s.boilerpipe.labels.DefaultLabels
     */
     ...
     * to the data structure. However it is recommended to use the label-specific methods in {@link de.l3s.boilerpipe.document.TextBlock}
     * whenever possible.
     * 
    ...
    /**
     * Adds a set of labels to this {@link de.l3s.boilerpipe.document.TextBlock}.
