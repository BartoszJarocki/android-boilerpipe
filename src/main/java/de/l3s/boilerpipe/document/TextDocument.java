...
public class TextDocument implements Cloneable {
    ...
    /**
     * Returns the {@link de.l3s.boilerpipe.document.TextDocument}'s content.
     * 
    ...
    /**
     * Returns the {@link de.l3s.boilerpipe.document.TextDocument}'s content, non-content or both
     * 
