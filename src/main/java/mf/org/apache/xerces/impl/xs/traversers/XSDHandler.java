...
public class XSDHandler {
    ...
    private String doc2SystemId(Element ele) {
         ...
         */
        if(ele.getOwnerDocument() instanceof mf.org.apache.xerces.impl.xs.opti.SchemaDOM){
            documentURI = ((mf.org.apache.xerces.impl.xs.opti.SchemaDOM) ele.getOwnerDocument()).getDocumentURI();
        }
