...
public class DOMUtil {
    ...
    public static void setHidden(Node node) {
        if (node instanceof mf.org.apache.xerces.impl.xs.opti.NodeImpl)
            ((mf.org.apache.xerces.impl.xs.opti.NodeImpl)node).setReadOnly(true, false);
    ...
    public static void setVisible(Node node) {
        if (node instanceof mf.org.apache.xerces.impl.xs.opti.NodeImpl)
            ((mf.org.apache.xerces.impl.xs.opti.NodeImpl)node).setReadOnly(false, false);
        else if (node instanceof mf.org.apache.xerces.dom.NodeImpl)
    ...
    public static boolean isHidden(Node node) {
        if (node instanceof mf.org.apache.xerces.impl.xs.opti.NodeImpl)
            return ((mf.org.apache.xerces.impl.xs.opti.NodeImpl)node).getReadOnly();
        else if (node instanceof mf.org.apache.xerces.dom.NodeImpl)
